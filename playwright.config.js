...
const Config = ({
  testDir: './tests',
  //retries:1, // if retries:2 means failed test will run again for 2 times. If it passes on the 1st re-run, then it won't execute one more time.Report only shows such testcase
