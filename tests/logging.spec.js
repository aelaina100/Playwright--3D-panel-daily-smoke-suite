...
//test.describe.configure({ mode: 'parallel' }); // independent serial mode (All test(s) run even if the one(s) b4it fails)
...
test('Validate the 6-panel page is accessible to users after clicking on ENTER', async ({browser})=> {
