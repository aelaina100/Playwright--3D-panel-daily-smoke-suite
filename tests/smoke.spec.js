...
test('@Smoke Verify that the 6-panel page loads correctly', async ({ browser }) => {
  ...
  await expect(page.locator("button[data-testid='open-menu-button']"), "Expecting that users can click on the burger menu").toBeEnabled();
  await test.step("Closing the application page", async () => {
  await page.close(); });
});
...
test('@Smoke Verify that the "LET US CONNECT" panel is visible and fully loaded', async ({ browser }) => {
 ...
 //await page.waitForTimeout(2000); // to view in slow mode. remove it !
  ...
  await expect(page.locator("button[data-testid= 'submit-button']"), "Expecting the burger menu to be enabled (clickable)").toBeEnabled();
  await test.step("Closing the application page", async () => {
  await page.close(); });
});
...
test.only(`@Smoke- Feed Page Accessibility – [AN INTRO TO CINCO], loads successfully`, async ({ browser }) => {
  ...
  await expect(page.getByText(title_feedPage1_panel1).nth(0), "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
  ...
  await expect(page.getByText(title_feedPage2_panel1).nth(0), "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
 ...
 await test.step("Closing the feed page", async () => {
  ...
  await expect(page.getByText(title_feedPage3_panel1).nth(0), "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
...
test('@Smoke Verify the accessibility of the feed pages for [Cinco’s XM Solutions] for users', async ({ browser }) => {
  ...
  await page.locator("span[class*= 'Title']").nth(0).click(); // click on the first sub-topic [Brand activations]
  await page.waitForTimeout(2000); // to view in slow mode. remove it !
  //Validating the title of the feed page is visible to user
  const title_feedPage1_panel2 = "Brand Activations";
  const container_feedPage1_panel2 = page.locator("div[class*= 'BrandingContainer']");
  await expect(container_feedPage1_panel2, "Expecting the title of the feed page to be present in the HTML mark-up").toContainText(title_feedPage1_panel2);
  await expect(container_feedPage1_panel2, "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
  // Navigate back to the sub-topic page, in order to click on the 2nd sub-topic page:
  await page.goBack();

  await page.locator("span[class*= 'Title']").nth(1).click(); // click on the second sub-topic.[Strategies sponsership]
  const title_feedPage2_panel2 = "Strategic Sponsorships";
  const container_feedPage2_panel2 = page.locator("div[class*= 'BrandingContainer']");
  await expect(container_feedPage2_panel2, "Expecting the title of the feed page to be present in the HTML mark-up").toContainText(title_feedPage2_panel2);
  await expect(container_feedPage2_panel2, "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
  await page.waitForTimeout(2000);
  // Navigate back to the sub-topic page, in order to click on the 2nd sub-topic page:
  await page.goBack();

  await page.locator("span[class*= 'Title']").nth(2).click(); // click on the third sub-topic[XM Digital Services]
  const title_feedPage3_panel2 = "XM Digital Services";
  const container_feedPage3_panel2 = page.locator("div[class*= 'BrandingContainer']");
  await expect(container_feedPage3_panel2, "Expecting the title of the feed page to be present in the HTML mark-up").toContainText(title_feedPage3_panel2);
  await expect(container_feedPage3_panel2, "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
  //await page.waitForTimeout(2000);
  await page.close();
});
...
test('@Smoke Verify the accessibility of the feed pages for [Cinco AI Experience] to users', async ({ browser }) => {
  ...
  await page.locator("span[class*= 'Title']").nth(0).click(); // click on the first sub-topic [Platform Features]
  await page.waitForTimeout(2000); // to view in slow mode. remove it !
  //Validating the title of the feed page is visible to user
  const title_feedPage1_panel3 = "Platform Features";
  const container_feedPage1_panel3 = page.locator("div[class*= 'BrandingContainer']");
  await expect(container_feedPage1_panel3, "Expecting the title of the feed page to be present in the HTML mark-up").toContainText(title_feedPage1_panel3);
  await expect(container_feedPage1_panel3, "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
  // Navigate back to the sub-topic page, in order to click on the 2nd sub-topic page:
  await page.goBack();

  await page.locator("span[class*= 'Title']").nth(1).click(); // click on the second sub-topic.[Seamless Access]
  const title_feedPage2_panel3 = "Seamless Access";
  const container_feedPage2_panel3 = page.locator("div[class*= 'BrandingContainer']");
  await expect(container_feedPage2_panel3, "Expecting the title of the feed page to be present in the HTML mark-up").toContainText(title_feedPage2_panel3);
  await expect(container_feedPage2_panel3, "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
  await page.waitForTimeout(2000);
  // Navigate back to the sub-topic page, in order to click on the 2nd sub-topic page:
  await page.goBack();

  await page.locator("span[class*= 'Title']").nth(2).click(); // click on the third sub-topic[Advanced Analytics]
  const title_feedPage3_panel3 = "Advanced Analytics";
  const container_feedPage3_panel3 = page.locator("div[class*= 'BrandingContainer']");
  await expect(container_feedPage3_panel3, "Expecting the title of the feed page to be present in the HTML mark-up").toContainText(title_feedPage3_panel3);
  await expect(container_feedPage3_panel3, "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
  await page.waitForTimeout(2000);
  // Navigate back to the sub-topic page, in order to click on the 2nd sub-topic page:
  await page.goBack();

  await page.locator("span[class*= 'Title']").nth(2).click(); // click on the third sub-topic[Advanced Analytics]
  const title_feedPage4_panel3 = "Advanced Analytics";
  const container_feedPage4_panel3 = page.locator("div[class*= 'BrandingContainer']");
  await expect(container_feedPage4_panel3, "Expecting the title of the feed page to be present in the HTML mark-up").toContainText(title_feedPage4_panel3);
  await expect(container_feedPage4_panel3, "Expecting the title of the feed page to be visible to users on the web page").toBeVisible();
  //await page.waitForTimeout(2000);      
  await page.close();
});
