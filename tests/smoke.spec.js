...
test(`🚬@Smoke Verify that the 'Enter' App button appears and is visible to the user.`, async ({ page }) => {
 ...
 // Start polling in the background
  const slowNetworkPolling = await loginPage.pollForSlowNetworkPopup();
  ...
  // Stop polling just before closing the page
  slowNetworkPolling.stop();
  await slowNetworkPolling.done; // Ensure the polling loop has exited
